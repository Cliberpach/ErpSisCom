            ...
            <div class="modal-body">
                ...
                <form role="form" action="{{route('almacenes.marcas.store')}}" method="POST" id="crear_marca">
                   ...
                   <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('marca_guardar') ? ' is-invalid' : '' }}" name="marca_guardar" id="marca_guardar" value="{{old('marca_guardar')}}"   onkeyup="return mayus(this)" required>
