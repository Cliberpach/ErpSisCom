                ...
                <div class="col-md-10">
                    <div class="row">
                        <div class="col-md-6 text-center">
                            ...
                            <br>
                            <button type="submit" class="btn btn-primary btn-ticket-N"><i class="fa fa-download"
                                    aria-hidden="true"></i></button>
                        </div>
                        <div class="col-md-6 text-center">
                            <label for="">Formato 80</label>
                            <br>
                            <button type="submit" class="btn btn-primary btn-ticket-O"><i class="fa fa-download"
                                    aria-hidden="true"></i></button>
                        </div>
                    </div>
                </div>
