                    ...
                    <form action="{{route('ventas.notas.store')}}" method="POST" id="enviar_documento">
                        ...
                        <div class="row">
                            <div class="col-sm-6 b-r">
                                <h4 class=""><b>Nota de Crédito</b></h4>
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Registrar datos de la nota de crédito:</p>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="text" id="comprobante_afectado" name="comprobante_afectado" class="form-control {{ $errors->has('comprobante_afectado') ? ' is-invalid' : '' }}" value="{{old('comprobante_afectado',$documento->serie.'-'.$documento->correlativo )}}" readonly>
                                ...
                                <div class="form-group">
                                    <label >Empresa: </label>
                                    <input type="text" id="empresa" name="empresa" class="form-control {{ $errors->has('empresa') ? ' is-invalid' : '' }}" value="{{old('empresa',$documento->ruc_empresa.' - '.$documento->empresa )}}" readonly>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <label >Cliente: </label>
                                    <input type="text" id="cliente" name="cliente" class="form-control {{ $errors->has('empresa') ? ' is-invalid' : '' }}" value="{{old('cliente',$documento->documento_cliente.' - '.$documento->cliente )}}" readonly>
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h4 class=""><b>Detalle de la Nota de credito</b></h4>
                                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        //OBTENER LOTES
        obtenerTipocliente("{{$documento->cliente_id}}")
