        ...
        "columns": [
            ...
            
            {
                ...
                render: function(data) {
                    ...
                    if(data.sunat === '0')
                    {
                        cadena = cadena + "<li><a class='dropdown-item' onclick='enviarSunat(" +data.id+ ")'  title='Enviar Sunat'><b><i class='fa fa-send'></i> Enviar Sunat</a></b></li>";
                    }
                    
                    if(data.sunat === '1')
                    {
                        cadena = cadena  +
                        "<li><a class='dropdown-item' onclick='guia(" +data.id+ ")'  title='Guia Remision'><b><i class='fa fa-file'></i> Guia Remision</a></b></li>"
                        + "<li><a class='dropdown-item' href='"+ url_nota +"'  title='Notas'><b><i class='fa fa-file-o'></i> Notas</a></b></li>" + "<li class='dropdown-divider d-none'></li>";
                    }

                    if(data.sunat === '2')
                    {
                        cadena = cadena +                        
                        "<li class='d-none'><a class='dropdown-item' onclick='eliminar(" + data.id + ")' title='Eliminar'><b><i class='fa fa-trash'></i> Eliminar</a></b></li>";
                    }
