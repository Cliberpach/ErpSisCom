...
<body>
    <div style="width: 100%; margin-left: -9mm; margin-right: -9mm; margin-top: -5mm" class="tipo-letra">
        ...
        <div class="cuadroDerecha">
            <div class="ruc">R.U.C: {{ DB::table('empresas')->count() == 0 ? '- ' : DB::table('empresas')->first()->ruc }}</div>

            <div class="title">BOLETA DE VENTAS
                <br>
        ...
        <div style="font-size:14px;position:absolute;left: 15%;top:17px;">
            ...
            <br>
            Telefono: {{ DB::table('empresas')->count() == 0 ? '- ' : DB::table('empresas')->first()->celular }}
        </div>
        <div class="nombre">
