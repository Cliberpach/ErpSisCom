            ...
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_inicio_actividad">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_inicio_actividad" name="fecha_inicio_actividad" class="form-control {{ $errors->has('fecha_inicio_actividad') ? ' is-invalid' : '' }}" value="{{old('fecha_inicio_actividad', getFechaFormato($vendedor->fecha_inicio_actividad, 'd/m/Y'))}}" readonly required >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12" id="fecha_fin_actividad">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_fin_actividad" name="fecha_fin_actividad" class="form-control {{ $errors->has('fecha_fin_actividad') ? ' is-invalid' : '' }}" value="{{old('fecha_fin_actividad', (!empty($vendedor->fecha_fin_actividad)) ? getFechaFormato($vendedor->fecha_fin_actividad, 'd/m/Y') : "")}}" readonly >
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_inicio_planilla">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_inicio_planilla" name="fecha_inicio_planilla" class="form-control {{ $errors->has('fecha_inicio_planilla') ? ' is-invalid' : '' }}" value="{{old('fecha_inicio_planilla', (!empty($vendedor->fecha_inicio_planilla)) ? getFechaFormato($vendedor->fecha_inicio_planilla, 'd/m/Y') : "")}}" readonly >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12" id="fecha_fin_planilla">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_fin_planilla" name="fecha_fin_planilla" class="form-control {{ $errors->has('fecha_fin_planilla') ? ' is-invalid' : '' }}" value="{{old('fecha_fin_planilla', (!empty($vendedor->fecha_fin_planilla)) ? getFechaFormato($vendedor->fecha_fin_planilla, 'd/m/Y') : "")}}" readonly >
                    </div>
                </div>
            </div>
            <div class="row">
